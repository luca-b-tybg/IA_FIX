...
public class COFTakeUserInput {
    ...
    public COFUserInputResult getUserInput() {
       ...
       // CircleOfFifthsKeyFile.Key key = null;
        CircleOfFifthsMinorMajor CircleOfFifthsMinorMajor = null;
        ...
        while (true) {
            ...
            try {
            //    key = CircleOfFifthsKeyFile.Key.valueOf(keyEntered); // Reference Key enum from scale.KeyFile
       ...
       // System.out.println("Key is: " + key);
        ...
        while (true) {
            ...
            try {
                CircleOfFifthsMinorMajor = CircleOfFifthsMinorMajor.valueOf(mmEntered); // Reference Mode enum from diatonicscale.ModeFile
        ...
        System.out.println("Chose: " + CircleOfFifthsMinorMajor);

        return new COFUserInputResult();
    }
}