    ...
    private void openFileDialog() {
        ...
        if (fileChooser.showOpenDialog(parentWindow) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                validateProgressionFileContent(content);
                ...
                JOptionPane.showMessageDialog(parentWindow,
                        e.getMessage(),
                        "Progression File Error",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }

    private void validateProgressionFileContent(String progressionFileContent){
        if(progressionFileContent.isEmpty()) {
            throw new RuntimeException("No progression file content");
        }
    }
