...
- ``ui.DiatonicScalePanel`` - Diatonic scale user interface 
- ``ui.CircleOfFifthsPanel`` - Circle of Fifths user interface
-  ``ui.MelodyGeneratorPanel`` - Melody generator user interface
